...
export default AuthenticatedComponent(class AddPoll extends React.Component {
    ...
    return (
      <div className="container" id="dashboard">
        ...
        <form ref="addPoll">
          ...
          <Input name="name" type="text" placeholder="Enter a question" value={this.state.username}
